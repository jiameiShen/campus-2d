	...
	*/
        ...
        Handler.extend({
          ...
          getValueByKeyPath: function (t, e) {
            ...
            '/' === t.charAt(0)
              ...
              : r.length > 1 &&
                ((a = e.context.path.slice(0)), a.pop(), (a = this.normalizePath(a.concat(r))))
            try {
              t = r[r.length - 1]
              ...
              if (u && 'object' == typeof u && t in u && n !== u[t])
                return (
                  (u[t] = Handler.gen(u[t], t, { currentContext: o, templateCurrentContext: u })),
                  u[t]
                )
            } catch (t) {}
            return '@' + r.join('/')
    ...
    function (t, e, n) {
      ...
      t.exports = {
        ...
        title: function (t, e) {
          for (var n = r(3, 7, t, e), a = [], o = 0; o < n; o++)
      ...
      var g = (function () {
          ...
          function e(t, e, n, r, a) {
            function o(t, e) {
              ...
              return (
                (a = e ? '"' + n(e) + '"' : 'end of input'),
                'Expected ' + r + ' but ' + a + ' found.'
              )
            }
            ;(this.expected = t),
              (this.found = e),
          ...
          function g(t) {
            ...
            function y(e) {
              ...
              return (
                tr !== e &&
                  (tr > e && ((tr = 0), (er = { line: 1, column: 1, seenCR: !1 })),
                  n(er, tr, e),
                  (tr = e)),
                er
              )
            ...
            function P() {
              ...
              return (
                ...
                null === t &&
                  ...
                  null === t &&
                    ((t = S()),
                    null === t && ((t = D()), null === t && ((t = q()), null === t && (t = F()))))),
                t
              )
            }
            function T() {
            ...
            function O() {
              ...
              return (
                null !== n && ((Qn = e), (n = ue(n))), null === n ? ((Zn = e), (e = n)) : (e = n), e
              )
            }
            function I() {
              var e, n, r, a
            ...
            function B() {
              ...
              if (
                (ar++,
                (e = Zn),
                91 === t.charCodeAt(Zn) ? ((n = ke), Zn++) : ((n = null), 0 === ar && b(Ee)),
                null !== n)
              )
                if (
            ...
            function dt() {
              ...
              if (
                ...
                null !== r
                  ? ((Qn = e), (n = Un(r)), null === n ? ((Zn = e), (e = n)) : (e = n))
                  : ((Zn = e), (e = kt))
              } else (Zn = e), (e = kt)
              return e
            }
            function mt() {
              ...
              if (
                ((e = Zn),
                t.substr(Zn, 2) === Bn ? ((n = Bn), (Zn += 2)) : ((n = null), 0 === ar && b(Gn)),
                null !== n)
              ) {
                if (
                  ((r = []),
                ...
                null !== r
                  ? ((Qn = e), (n = Wn(r)), null === n ? ((Zn = e), (e = n)) : (e = n))
                  : ((Zn = e), (e = kt))
              } else (Zn = e), (e = kt)
              return e
            }
            function vt() {
              ...
              if (
                ((e = Zn),
                t.substr(Zn, 2) === Yn ? ((n = Yn), (Zn += 2)) : ((n = null), 0 === ar && b($n)),
                null !== n)
              ) {
                if (
                  ((r = []),
                ...
                null !== r
                  ? ((Qn = e), (n = Jn(r)), null === n ? ((Zn = e), (e = n)) : (e = n))
                  : ((Zn = e), (e = kt))
              } else (Zn = e), (e = kt)
              return e
            }
            ...
            if ('startRule' in bt) {
              if (!(bt.startRule in wt))
                throw new Error('Can\'t start parsing from rule "' + bt.startRule + '".')
              Ct = wt[bt.startRule]
            }
            if (((n.offset = x), (n.text = g), (yt = Ct()), null !== yt && Zn === t.length))
              return yt
            throw (
              (w(rr),
              (Qn = Math.max(Zn, nr)),
            ...
            switch (i) {
              case 'number':
                ...
                ;(s[0] = +s[0]),
                  ...
                  void 0 !== u.min &&
                    void 0 === u.max &&
                    l.equal('value', t.path, s[0], u.min, r, '[value] ' + n),
                  u.decimal &&
                    (void 0 !== u.dmin &&
                      void 0 !== u.dmax &&
                    ...
                    void 0 !== u.dmin &&
                      void 0 === u.dmax &&
                      l.equal('value', t.path, s[1].length, u.dmin, r))
                break
              case 'boolean':
                break
              case 'string':
                ;(c = e.match(new RegExp(t.template, 'g'))),
                  ...
                  void 0 !== u.min &&
                    void 0 === u.max &&
                    l.equal('repeat count', t.path, c, u.min, r)
                break
              case 'regexp':
    ...
    function (t, e, n) {
      ...
      function o(t) {
        ...
        for (var n in r.Mock._mocked) {
          ...
          if ((!a.rurl || e(a.rurl, t.url)) && (!a.rtype || e(a.rtype, t.type.toLowerCase())))
            return a
        }
      }
      function u(t, e) {
            ...
            function e() {
              ;(n.readyState = r.HEADERS_RECEIVED),
                ...
                (n.response = n.responseText =
                  JSON.stringify(u(n.custom.template, n.custom.options), null, 4)),
                (n.readyState = r.DONE),
                n.dispatchEvent(new Event('readystatechange')),
